...
abstract class BaseFriend extends BaseObject implements Persistent
{
    ...
    public function setGroupid($v)
    {
        ...
        if ($this->groupid !== $v) {
            $this->groupid = $v;
            $this->modifiedColumns[] = FriendPeer::GROUPID;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(FriendPeer::GROUPID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FriendPeer::GROUPID)) $criteria->add(FriendPeer::GROUPID, $this->groupid);
    ...
    {
        $criteria = new Criteria(FriendPeer::DATABASE_NAME);
        $criteria->add(FriendPeer::GROUPID, $this->groupid);
