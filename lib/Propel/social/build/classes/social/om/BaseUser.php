...
abstract class BaseUser extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the avatar_filename field.
     * @var        string
     */
    ...
    /**
     * Get the [avatar_filename] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [hide_stream] column value.
     *
     * @return int
     */
    public function getHideStream()
    {
        return $this->hide_stream;
    }
    ...
    public function setActivateCode($v)
    {
        ...
        if ($this->activate_code !== $v) {
            ...
            $this->modifiedColumns[] = UserPeer::ACTIVATE_CODE;
        }
    ...
    public function setIsActivated($v)
    {
        ...
        if ($this->is_activated !== $v) {
            $this->is_activated = $v;
            $this->modifiedColumns[] = UserPeer::IS_ACTIVATED;
        }
    ...
    /**
     * Set the value of [avatar_filename] column.
     *
     * @param string $v new value
     * @return User The current object (for fluent API support)
     */
    public function setAvatarFilename($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->avatar_filename !== $v) {
            $this->avatar_filename = $v;
            $this->modifiedColumns[] = UserPeer::AVATAR_FILENAME;
        }
     ...
     * @return User The current object (for fluent API support)
     */
    public function setHideStream($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->hide_stream !== $v) {
            $this->hide_stream = $v;
            $this->modifiedColumns[] = UserPeer::HIDE_STREAM;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UserPeer::ACTIVATE_CODE)) {
            $modifiedColumns[':p' . $index++]  = '`ACTIVATE_CODE`';
        }
        if ($this->isColumnModified(UserPeer::IS_ACTIVATED)) {
        ...
        if ($this->isColumnModified(UserPeer::INVISIBLE)) {
            $modifiedColumns[':p' . $index++]  = '`INVISIBLE`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`LAST_NAME`':
                        ...
                        break;
                    case '`ACTIVATE_CODE`':
                        $stmt->bindValue($identifier, $this->activate_code, PDO::PARAM_STR);
                        break;
                    case '`IS_ACTIVATED`':
                        $stmt->bindValue($identifier, $this->is_activated, PDO::PARAM_INT);
                        break;
                    ...
                    case '`HIDE_STREAM`':
                        ...
                        break;
                    case '`INVISIBLE`':
                        $stmt->bindValue($identifier, $this->invisible, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
