...
abstract class BaseUserPeer
{
    ...
    /** the column name for the ACTIVATE_CODE field */
    const ACTIVATE_CODE = 'users.ACTIVATE_CODE';

    /** the column name for the IS_ACTIVATED field */
    const IS_ACTIVATED = 'users.IS_ACTIVATED';
    ...
    const INVISIBLE = 'users.INVISIBLE';
