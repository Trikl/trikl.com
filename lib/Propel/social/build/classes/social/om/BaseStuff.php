...
abstract class BaseStuff extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the stuffid field.
     * @var        int
     */
    protected $stuffid;
    ...
    /**
     * Set the value of [stuffid] column.
     *
     * @param int $v new value
     * @return Stuff The current object (for fluent API support)
     */
    public function setStuffid($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->stuffid !== $v) {
            $this->stuffid = $v;
            $this->modifiedColumns[] = StuffPeer::STUFFID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->stuffid = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 2; // 2 = StuffPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`STUFFID`':
                        $stmt->bindValue($identifier, $this->stuffid, PDO::PARAM_INT);
                        break;
                    case '`CONTENT`':
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setStuffid($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StuffPeer::STUFFID)) $criteria->add(StuffPeer::STUFFID, $this->stuffid);
    ...
    {
        $criteria = new Criteria(StuffPeer::DATABASE_NAME);
        $criteria->add(StuffPeer::STUFFID, $this->stuffid);
    ...
    /**
     * Generic method to set the primary key (stuffid column).
     *
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setStuffid(NULL); // this is a auto-increment column, so set to default value
        }
    }
