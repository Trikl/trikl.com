...
abstract class BaseProfile extends BaseObject implements Persistent
{
    ...
    public function setUserid($v)
    {
        ...
        if ($this->userid !== $v) {
            $this->userid = $v;
            $this->modifiedColumns[] = ProfilePeer::USERID;
        }
    ...
    public function setBio($v)
    {
        ...
        if ($this->bio !== $v) {
            $this->bio = $v;
            $this->modifiedColumns[] = ProfilePeer::BIO;
        }
    ...
    public function setWebsite($v)
    {
        ...
        if ($this->website !== $v) {
            $this->website = $v;
            $this->modifiedColumns[] = ProfilePeer::WEBSITE;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProfilePeer::USERID)) {
            $modifiedColumns[':p' . $index++]  = '`USERID`';
        }
        if ($this->isColumnModified(ProfilePeer::PHONE)) {
            $modifiedColumns[':p' . $index++]  = '`PHONE`';
        }
        if ($this->isColumnModified(ProfilePeer::BIO)) {
            $modifiedColumns[':p' . $index++]  = '`BIO`';
        }
        if ($this->isColumnModified(ProfilePeer::WEBSITE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProfilePeer::USERID)) $criteria->add(ProfilePeer::USERID, $this->userid);
        if ($this->isColumnModified(ProfilePeer::PHONE)) $criteria->add(ProfilePeer::PHONE, $this->phone);
        if ($this->isColumnModified(ProfilePeer::BIO)) $criteria->add(ProfilePeer::BIO, $this->bio);
        if ($this->isColumnModified(ProfilePeer::WEBSITE)) $criteria->add(ProfilePeer::WEBSITE, $this->website);
    ...
    {
        $criteria = new Criteria(ProfilePeer::DATABASE_NAME);
        $criteria->add(ProfilePeer::USERID, $this->userid);
