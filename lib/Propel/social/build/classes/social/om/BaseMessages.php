...
abstract class BaseMessages extends BaseObject implements Persistent
{
    ...
    public function setMessageid($v)
    {
        ...
        if ($this->messageid !== $v) {
            $this->messageid = $v;
            $this->modifiedColumns[] = MessagesPeer::MESSAGEID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = MessagesPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MessagesPeer::MESSAGEID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MessagesPeer::MESSAGEID)) $criteria->add(MessagesPeer::MESSAGEID, $this->messageid);
    ...
    {
        $criteria = new Criteria(MessagesPeer::DATABASE_NAME);
        $criteria->add(MessagesPeer::MESSAGEID, $this->messageid);
