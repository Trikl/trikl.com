...
abstract class BaseStuffPeer
{
    ...
    /** the column name for the STUFFID field */
    const STUFFID = 'stuff.STUFFID';
     ...
     * e.g. StuffPeer::$fieldNames[StuffPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Stuffid', 'Content', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('stuffid', 'content', ),
        BasePeer::TYPE_COLNAME => array (StuffPeer::STUFFID, StuffPeer::CONTENT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('STUFFID', 'CONTENT', ),
        BasePeer::TYPE_FIELDNAME => array ('StuffID', 'Content', ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. StuffPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Stuffid' => 0, 'Content' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('stuffid' => 0, 'content' => 1, ),
        BasePeer::TYPE_COLNAME => array (StuffPeer::STUFFID => 0, StuffPeer::CONTENT => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('STUFFID' => 0, 'CONTENT' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('StuffID' => 0, 'Content' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    {
        $toNames = StuffPeer::getFieldNames($toType);
        $key = isset(StuffPeer::$fieldKeys[$fromType][$name]) ? StuffPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(StuffPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, StuffPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return StuffPeer::$fieldNames[$type];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(StuffPeer::STUFFID);
            $criteria->addSelectColumn(StuffPeer::CONTENT);
        } else {
            $criteria->addSelectColumn($alias . '.STUFFID');
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(StuffPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(StuffPeer::DATABASE_NAME);
     ...
     *
     * @param      Stuff $obj A Stuff object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = (string) $obj->getStuffid();
            } // if key === null
            StuffPeer::$instances[$key] = $obj;
        }
    }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(StuffPeer::$instances[$key])) {
                return StuffPeer::$instances[$key];
            }
        }
    ...
    {
        return Propel::getDatabaseMap(StuffPeer::DATABASE_NAME)->getTable(StuffPeer::TABLE_NAME);
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(StuffPeer::STUFFID) && $criteria->keyContainsValue(StuffPeer::STUFFID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.StuffPeer::STUFFID.')');
        }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(StuffPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(StuffPeer::STUFFID);
            $value = $criteria->remove(StuffPeer::STUFFID);
            if ($value) {
                $selectCriteria->add(StuffPeer::STUFFID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(StuffPeer::STUFFID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(StuffPeer::DATABASE_NAME);
        $criteria->add(StuffPeer::STUFFID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(StuffPeer::DATABASE_NAME);
            $criteria->add(StuffPeer::STUFFID, $pks, Criteria::IN);
