...
abstract class BaseStatus extends BaseObject implements Persistent
{
    ...
    public function setPostid($v)
    {
        ...
        if ($this->postid !== $v) {
            $this->postid = $v;
            $this->modifiedColumns[] = StatusPeer::POSTID;
        }
    ...
    public function setUserid($v)
    {
        ...
        if ($this->userid !== $v) {
            $this->userid = $v;
            $this->modifiedColumns[] = StatusPeer::USERID;
        }
    ...
    public function setBucketid($v)
    {
        ...
        if ($this->bucketid !== $v) {
            $this->bucketid = $v;
            $this->modifiedColumns[] = StatusPeer::BUCKETID;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = StatusPeer::DATE;
            }
    ...
    public function setDrops($v)
    {
        ...
        if ($this->drops !== $v) {
            $this->drops = $v;
            $this->modifiedColumns[] = StatusPeer::DROPS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = StatusPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(StatusPeer::POSTID)) {
            $modifiedColumns[':p' . $index++]  = '`POSTID`';
        }
        if ($this->isColumnModified(StatusPeer::USERID)) {
            $modifiedColumns[':p' . $index++]  = '`USERID`';
        }
        if ($this->isColumnModified(StatusPeer::BUCKETID)) {
            $modifiedColumns[':p' . $index++]  = '`BUCKETID`';
        }
        if ($this->isColumnModified(StatusPeer::DATE)) {
            $modifiedColumns[':p' . $index++]  = '`DATE`';
        }
        if ($this->isColumnModified(StatusPeer::STATUS)) {
            $modifiedColumns[':p' . $index++]  = '`STATUS`';
        }
        if ($this->isColumnModified(StatusPeer::DROPS)) {
            $modifiedColumns[':p' . $index++]  = '`DROPS`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`STATUS`':
                        ...
                        break;
                    case '`DROPS`':
                        $stmt->bindValue($identifier, $this->drops, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getBucketid(),
            $keys[3] => $this->getDate(),
            $keys[4] => $this->getStatus(),
            $keys[5] => $this->getDrops(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setBucketid($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setDate($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setStatus($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setDrops($arr[$keys[5]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StatusPeer::POSTID)) $criteria->add(StatusPeer::POSTID, $this->postid);
        if ($this->isColumnModified(StatusPeer::USERID)) $criteria->add(StatusPeer::USERID, $this->userid);
        if ($this->isColumnModified(StatusPeer::BUCKETID)) $criteria->add(StatusPeer::BUCKETID, $this->bucketid);
        if ($this->isColumnModified(StatusPeer::DATE)) $criteria->add(StatusPeer::DATE, $this->date);
        if ($this->isColumnModified(StatusPeer::STATUS)) $criteria->add(StatusPeer::STATUS, $this->status);
        if ($this->isColumnModified(StatusPeer::DROPS)) $criteria->add(StatusPeer::DROPS, $this->drops);
    ...
    {
        $criteria = new Criteria(StatusPeer::DATABASE_NAME);
        $criteria->add(StatusPeer::POSTID, $this->postid);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setBucketid($this->getBucketid());
        $copyObj->setDate($this->getDate());
        $copyObj->setStatus($this->getStatus());
        $copyObj->setDrops($this->getDrops());
        if ($makeNew) {
            $copyObj->setNew(true);
