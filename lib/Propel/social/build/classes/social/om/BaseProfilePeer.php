...
abstract class BaseProfilePeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Userid', 'Phone', 'Bio', 'Website', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('userid', 'phone', 'bio', 'website', ),
        BasePeer::TYPE_COLNAME => array (ProfilePeer::USERID, ProfilePeer::PHONE, ProfilePeer::BIO, ProfilePeer::WEBSITE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USERID', 'PHONE', 'BIO', 'WEBSITE', ),
        BasePeer::TYPE_FIELDNAME => array ('userid', 'phone', 'bio', 'website', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Userid' => 0, 'Phone' => 1, 'Bio' => 2, 'Website' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('userid' => 0, 'phone' => 1, 'bio' => 2, 'website' => 3, ),
        BasePeer::TYPE_COLNAME => array (ProfilePeer::USERID => 0, ProfilePeer::PHONE => 1, ProfilePeer::BIO => 2, ProfilePeer::WEBSITE => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USERID' => 0, 'PHONE' => 1, 'BIO' => 2, 'WEBSITE' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('userid' => 0, 'phone' => 1, 'bio' => 2, 'website' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ProfilePeer::USERID);
            $criteria->addSelectColumn(ProfilePeer::PHONE);
            $criteria->addSelectColumn(ProfilePeer::BIO);
            $criteria->addSelectColumn(ProfilePeer::WEBSITE);
        } else {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(ProfilePeer::USERID);
            $value = $criteria->remove(ProfilePeer::USERID);
            if ($value) {
                $selectCriteria->add(ProfilePeer::USERID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ProfilePeer::USERID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(ProfilePeer::DATABASE_NAME);
        $criteria->add(ProfilePeer::USERID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(ProfilePeer::DATABASE_NAME);
            $criteria->add(ProfilePeer::USERID, $pks, Criteria::IN);
