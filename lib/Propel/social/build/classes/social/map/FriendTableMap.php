...
class FriendTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'social.map.FriendTableMap';
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('GROUPID', 'Groupid', 'INTEGER', true, 50, null);
        $this->addColumn('USERID', 'Userid', 'INTEGER', true, 50, null);
        $this->addColumn('FRIENDID', 'Friendid', 'INTEGER', true, 50, null);
        // validators
    } // initialize()
